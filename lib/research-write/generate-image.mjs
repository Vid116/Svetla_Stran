...
const STYLE_PREFIX = 'Soft watercolor editorial illustration, warm golden tones, gentle natural lighting, dreamy atmosphere, minimal detail, wide landscape format, main subject placed in the vertical and horizontal center of the frame, ';
